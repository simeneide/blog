...
::: {.columns}
::: {.column width="55%"}
1. **Data** - hva vi lærer av
2. **Modell** - hva slags struktur har verden?
3. **Trening** = Data + Modell = hvordan finner vi den strukturen i dataen?
4. **Handling** - hva gjør vi med det vi har lært?
:::
::: {.column width="45%"}
![](img/ai-hal9000.svg){style="height: 420px; width: 100%; object-fit: contain;"}
:::
...
3. **Trening** - hvordan finner vi den strukturen i dataen?
...
- Konklusjon: Vi må ha riktig og effektiv regulering
:::
