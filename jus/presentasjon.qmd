...
Vi "trener" modellen ved å legge til data i prompten - samme prinsipp som hele dagen
:::

## Det er nå det skjer

::: {.incremental}
1. Utviklere går fra å skrive kode til å orkestrere agenter
2. Utviklere først fordi de står tettest på modellen
3. **Tool use er det som låser opp**
4. Det er ikke eksperimenter lenger - det er nyttig
:::

::: {.fragment style="margin-top: 30px; text-align: center; font-size: 1.2em; font-weight: 600;"}
Takk for meg!
:::