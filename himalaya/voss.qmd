...
```{=html}
<img class="clip" src="img/app-start.jpg" alt="Start fra Billing">
```
...
## 4. Hvor langt ned er det til noe flatt? [KLIPP]{.where .where-clip}

```{=html}
<img class="clip" src="img/app-glide.jpg" alt="Glidetall og rekkevidde">
```

::: {.notes}
Stillbilde, ikke klipp, og det er et bevisst valg: aa steppe replayet frame for
frame gir jevn video, men soek nullstiller estimatorene, saa GLIDE 10S faller
til "--". I et bilde om glidetall er nettopp det tallet poenget.

Her staar GLIDE 10S paa 10.9, og glidestraalene L/D 6, 8 og 10 treffer bakken
ved 2,5 km med stoppunktet markert. Glide range er satt til hoy kvalitet.
:::
