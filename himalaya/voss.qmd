...
<div class="hero">
  ...
  <div class="hero-text">
    <p class="hero-kicker">Sekken er pakka igjen</p>
...
## [APP]{.where .where-app} Og sånn ser det ut

::: {.todo}
Live på speilet telefon: du installerer selv mens du snakker. Si tallet høyt.
:::

::: {.notes}
Dette er beviset, ikke pastanden. Du installerer live mens de ser paa, og sier
hvor lang tid det tok.

Hvis speilingen ryker: hopp over dette og la QR-sliden staa. Salen installerer
uansett.
:::
...
Lages først når du rigger, se notatene.
:::
